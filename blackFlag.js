                ...
                .then(sentMessage => {
                  bot.onReplyToMessage(
                    ...
                    reply => {
                      ...
                      {
                        bot.sendMessage(msg.chat.id, "That seems invalid, try again! /blackFlag");
                      }
                      else if (reply.text == "") {
                        console.log("error");
                      }else{
                              ...
                              reply=>{
                                if(parseInt(reply.text)==NaN)
                                {
                                  ...
                                  if(size===1){
                                      ...
                                      //INSERT INTO blackflag (name, size, id1) VALUES (name,size,id1)
                                  }
                                  else if(size>1){
                                            ...
                                            if(size===2)
                                              {
                                                ...
                                                //INSERT INTO blackflag (name, size, id1, id2) VALUES (name, size, id1, id2);
                                              }
                                            else
                                            {
                                                      ...
                                                      if(size===3)
                                                       {
                                                        ...
                                                        //INSERT INTO blackflag VALUES (name, size, id1, id2, id3);
